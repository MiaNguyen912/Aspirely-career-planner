      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1 text-sm">
            <div className="truncate font-medium">{fileInfo?.name || "Your resume"}</div>
          </div>
        </div>

        {fileInfo?.url && (
          <object data={fileInfo.url} type="application/pdf" className="w-full h-[300px] rounded-lg border border-white/20 bg-white/10">
